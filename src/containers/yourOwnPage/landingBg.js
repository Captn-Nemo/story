  ...
  return (
    <>
      <Row>
        ...
        >
          <p className="chelsea f16 d-flex justify-content-center align-items-center">
            Get fully personalised story books with photos
          </p>
          <p className="asap f16 lightblack">
      ...
      <Row>
        <Col
          ...
          className="d-flex justify-content-center flex-column align-items-center p-5"
        >
          <p className="chelsea f16 d-flex align-items-center">
      ...
      <Row className="mt-5">
        ...
        >
          <span className="chelsea text-center text-bold f14 d-flex justify-content-center align-items-center">
        ...
        >
          <span className="amatic f13 text-center  d-flex justify-content-center align-items-center mb-5">
