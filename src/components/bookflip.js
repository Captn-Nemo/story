...
const Book = (props) => {
  ...
  const cleanCode = (code, id) => {
    ...
    newcode = newcode
      ...
      .replace(/MOHAMMED/g, props.fname.toUpperCase());
    if (props.gender === "f") {
      newcode = newcode
        .replace(/\bhe\b/g, "she")
  ...
  return (
    <div className="flipdiv">
      {props.loadedBook &&
        props.loadedBook.map((flipb, flipid) => {
          return (
            <FlipPage
              uncutPages={true}
              key="flip1"
                  ...
                  <article key={"article" + id} id={"page" + id}>
                    {id === 0 && (
                      <div style={{ position: "relative" }}>
                        {props.kid === "girl1" && flip.girl1 && (
                          <img
                            style={{ position: "absolute", margin: "0 50%" }}
                        ...
                        <div
                          dangerouslySetInnerHTML={createMarkup(flip.txt, id)}
                          style={{
                            position: "absolute",
                            left: "50%",
                            top: "0px",
                      ...
                      <div style={{ position: "relative" }}>
                        ...
                        <img
                          ...
                          style={{
                            ...
                            marginLeft: "2px",
                            marginTop: "2px",
                            boxShadow: "2px 2px 4px black,-2px 0px 2px black",
                          }}
                        />
                      </div>
                    )}
